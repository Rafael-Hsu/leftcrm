<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:99:"/www/wwwroot/2024/10/kh06_crm178.kaiwenit.com/public/../application/admin/view/dashboard/index.html";i:1731662278;s:88:"/www/wwwroot/2024/10/kh06_crm178.kaiwenit.com/application/admin/view/layout/default.html";i:1731127532;s:85:"/www/wwwroot/2024/10/kh06_crm178.kaiwenit.com/application/admin/view/common/meta.html";i:1731127532;s:87:"/www/wwwroot/2024/10/kh06_crm178.kaiwenit.com/application/admin/view/common/script.html";i:1731127532;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="panel panel-default panel-intro">
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade active in" id="one">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div style="font-weight: bold;border-bottom: 1px solid #ddd; padding-bottom: 5px; margin-bottom:5px;">企業公告</div>
                        ...
                        <?php if(is_array($cnews) || $cnews instanceof \think\Collection || $cnews instanceof \think\Paginator): $i = 0; $__LIST__ = $cnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            ...
                            <a href="/addons/cnews/index/ve?id=<?php echo $vo['id']; ?>" class="btn-addtabs aaa" title="<?php echo __('企業公告'); ?>">
                        ...
                        <!--<a href="/nihao" class="aaa">阿里商旅開发</a>-->
                    </div>
    ...
    padding-top: 10px;">
                ...
                <div class="row" style="margin-top:15px; display:none" id="statistics">
