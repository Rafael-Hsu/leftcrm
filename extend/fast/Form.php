 ...
 * @method static string label(string $name, string $value = null, array $options = []) label標籤
 ...
 * @method static string timepicker(string $name, string $value, array $options = []) 時間选择组件
 * @method static string datetimepicker(string $name, string $value, array $options = []) 日期時間选择组件
 * @method static string daterange(string $name, string $value, array $options = []) 日期区间组件
 * @method static string timerange(string $name, string $value, array $options = []) 時間区间组件
 * @method static string datetimerange(string $name, string $value, array $options = []) 日期時間区间组件
 ...
 * @method static string selectRange(string $name, string $begin, string $end, string $selected = null, array $options = []) 选择數字区间
...
class FormBuilder
{
     ...
     * @param mixed  $value
     * @param string $url        數据源地址
     * @param string $field      顯示的字段名稱,默认为name
     * @param string $primaryKey 主键,數据库中保存的值,默认为id
     * @param array  $options
     * @return string
     */
...
EOD;
     ...
     * 生成联动下拉列表
     *
     * @param string $url     联动获取數据源的URL地址
     * @param array  $names   联动字段名稱
     * @param array  $values  联动字段默认选中的值
     * @param array  $options 扩展屬性
     * @return string
     */
...
EOD;
    ...
    public function attributes($attributes)
    {
        ...
        // 拿HTML“required”屬性來说,假设是['required']數组,
        // 会已 required="required" 拼接起來,而不是用數字keys去拼接
