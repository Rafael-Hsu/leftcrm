...
class Date
{
     ...
     * 获取一个基于時間偏移的Unix時間戳
     *
     * @param string $type     時間类型，默认为day，可选minute,hour,day,week,month,quarter,year
     * @param int    $offset   時間偏移量 默认为0，正數表示当前type之后，负數表示当前type之前
     * @param string $position 時間的開始或結束，默认为begin，可选前(begin,start,first,front)，end
